...
function SideMenu() {
  return (
    <div className="bg-black-100 w-65 px-2 pt-24  min-h-full hidden lg:block  ">
      ...
      <div className=" hover:text-sky-100 text-grey-25 text-ft3  pt-5 px-5">
        <h1 className="font-semibold">
      ...
      <div className=" text-grey-25 text-ft3  pt-5 px-5 hover:text-sky-100">
        <h1 className="">
      ...
      <div className=" text-grey-25 text-ft5  pt-7 px-5 hover:text-sky-100">
        <h1 className="">
      ...
      <div className=" text-grey-25 text-ft5  pt-9 px-5 hover:text-sky-100">
        <h1 className="">
